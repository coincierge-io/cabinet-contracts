...
contract('Cng1400/CNG20: redeemFrom', async accounts => {
  let setupData;
  ...
  it('should return the correct account balance after when the it has one registered Ethereum addresses', async () => {
    ...
    await cng1400.redeemFrom(investor, getTokens(50), EMPTY_DATA, {from: issuer});
  ...
  it('should return the correct account balance after when the it has multiple registered Ethereum addresses', async () => {
    ...
    await cng1400.redeemFrom(investor2, getTokens(50), EMPTY_DATA, {from: issuer});
    ...
    await cng1400.redeemFrom(investor3, getTokens(50), EMPTY_DATA, {from: issuer});
  ...
  it('should return the correct account balance for different users with various number of eth addresses', async () => {
    ...
    await cng1400.redeemFrom(investor4, getTokens(50), EMPTY_DATA, {from: issuer});
